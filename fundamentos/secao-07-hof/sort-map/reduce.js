...
const somatorio = valorItens.reduce((acc, curr) => acc + curr, 30);

const numbers = [50, 85, -30, 3, 115];

const maiorValor = numbers.reduce((acc, curr) => acc > curr ? curr = acc : curr);

const numbers2 = [18, 19, 23, 53, 4, 5, 76, 23, 54];

const pares = numbers2.filter((number) => number % 2 === 0);
